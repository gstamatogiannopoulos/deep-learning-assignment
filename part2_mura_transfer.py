...
all_auc = history_head.history["auc"] + history_fine.history["auc"]
all_val_auc = history_head.history["val_auc"] + history_fine.history["val_auc"]
...
plt.plot(all_auc, label="train auc")
plt.plot(all_val_auc, label="val auc")
plt.axvline(x=HEAD_EPOCHS - 1, linestyle="--", label="fine-tune starts")
plt.xlabel("Epoch")
plt.ylabel("Value")
